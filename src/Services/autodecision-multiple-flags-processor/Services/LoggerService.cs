...
public interface ILoggerService
{
    void LogInfo(
        ...
        AutodecisionMultipleFlagsProcessor.DTOs.LogRequest? request = null
    );
    void LogWarning(
        string eventType,
        string message,
...
public class LoggerService : ILoggerService
{
    ...
    private void Log(
        ...
        AutodecisionMultipleFlagsProcessor.DTOs.LogRequest? logRequest = null
    )
    {
    ...
    private AutodecisionMultipleFlagsProcessor.DTOs.LogRequest? GetRequest()
    {
        try
        {
            return new AutodecisionMultipleFlagsProcessor.DTOs.LogRequest()
            {
